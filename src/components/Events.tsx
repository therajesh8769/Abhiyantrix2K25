...
const events: Event[] = [
  ...
  },
  {
    ...
    registrationLink: "https://unstop.com/p/flying-ace-indian-institute-of-engineering-science-and-technology-iiest-shibpur-1651772",
...

  {
    ...
    registrationLink: "https://unstop.com/p/stellar-odyssey-indian-institute-of-engineering-science-and-technology-iiest-shibpur-1651785",
                    ...
                    {selectedEvent.coordinators && selectedEvent.coordinators.length > 0 && (
                      <div className="bg-white/5 p-4 rounded-lg border border-white/10 col-span-2">
                        <div className="flex items-center gap-2 mb-3">
                          ...
                          <p className="text-gray-400 text-xs uppercase tracking-wider font-medium">Coordinators</p>
                        </div>
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                          {selectedEvent.coordinators.map((c, i) => (
                            <div key={i} className="bg-white/[0.04] rounded-xl p-3 border border-cyan-500/10">
                              <p className="text-cyan-300 font-semibold text-sm mb-0.5">{c.name}</p>
                              <p className="text-gray-500 text-xs mb-2">{c.year}</p>
                              {c.phone && (
                                <a
                                  href={`tel:${c.phone}`}
                                  className="flex items-center justify-center gap-2 w-full py-2.5 px-3 rounded-lg bg-cyan-500/10 hover:bg-cyan-500/20 border border-cyan-500/20 hover:border-cyan-400/40 text-cyan-400 hover:text-cyan-300 text-sm font-medium transition-all duration-200 active:scale-[0.97]"
                                >
