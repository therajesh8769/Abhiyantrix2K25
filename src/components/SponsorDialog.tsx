...
//                     <div className="relative rounded-2xl p-6 bg-gray-800 border border-gray-700">
...
//                         <div className="w-[280px] h-[280px] border border-gray-700 rounded-full" />
//                         <div className="w-[200px] h-[200px] border border-gray-700 rounded-full" />
//                         <div className="w-[120px] h-[120px] border border-gray-700 rounded-full" />
//                       </div>
...
//                 {/* Footer */}
//                 <div className="bg-gray-800 px-6 py-4 rounded-b-lg flex justify-end">
//                   <button
//                     type="button"
//                     onClick={onClose}
...
export function SponsorDialog({ isOpen, onClose }: SponsorDialogProps) {
  ...
  <div className="text-gray-300 text-sm space-y-1">
    <p>
      ...
      <span className="font-medium">Arya Jain:</span> 1234567890
    </p>
    <p>
      <span className="font-medium">Rohan Das:</span> 1234567890
    </p>
  </div>
